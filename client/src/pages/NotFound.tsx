  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center animate-fade-in">
      <div className="card max-w-xl w-full p-8 md:p-10 text-center">
        ...
        <p className="text-xs uppercase tracking-[0.18em] text-kad-text-muted mb-2">
          {t("notFound.code")}
        </p>
        <h2 className="text-2xl font-semibold text-kad-text-strong mb-2">{t("notFound.title")}</h2>
        <p className="text-sm text-kad-text-muted mb-8">{t("notFound.description")}</p>
