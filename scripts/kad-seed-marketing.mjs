...
function seedMarketing() {
  ...
  const tx = db.transaction(() => {
    db.prepare(
      ...
      org: ID.org,
      mission:
        "Phòng Marketing: Chịu trách nhiệm lên chiến dịch quảng cáo, viết content và tối ưu tỷ lệ chuyển đổi.",
      ...
      agents: [
        {
          id: ID.agents.main,
          name: "main-marketing",
          display_name: "Trợ lý Marketing",
          agent_type: "main",
          status: "active",
        },
        {
          id: ID.agents.content,
          name: "sub-content-creator",
        ...
        {
          id: ID.agents.ads,
          name: "sub-ads-optimizer",
          display_name: "Ads Optimizer",
          agent_type: "sub",
          status: "active",
        },
      ],
    ...
    const agents = [
      {
        ...
        type: "main",
        name: "main-marketing",
        display: "Trợ lý Marketing",
        role: "Đầu mối tiếp nhận yêu cầu chạy chiến dịch, phân việc cho content và ads.",
        parent: null,
      },
      {
        id: ID.agents.content,
        ...
        role: "Viết bài quảng cáo, kịch bản video.",
        parent: ID.agents.main,
      },
      {
        id: ID.agents.ads,
        type: "sub",
        name: "sub-ads-optimizer",
        display: "Ads Optimizer",
        role: "Tối ưu ngân sách, setup camp.",
        parent: ID.agents.main,
      },
    ];
    ...
    for (const a of agents) {
      insAgent.run({
        ...
        perms: JSON.stringify({
          create_task: a.type === "main",
          assign_task: a.type === "main",
